...
permalink: /en/web/archive/onboarding/setup-guide/
---
...
> ⚠️ *This is archived documentation. It describes the setup process for the legacy Customer Portal and Web Order System projects, which are no longer active. See [current Onboarding](../../onboarding/) for up-to-date guides.*
...
> 🔗 **Quick access:** See the team's [Useful URLs]({{ '/en/web/archive/onboarding/#useful-urls' | relative_url }}) list on the Onboarding page.
