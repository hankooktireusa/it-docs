---
layout: default
title: Updating WSDL File (Legacy)
permalink: /en/web/archive/standards-and-procedures/updating-wsdl-file/
---
...
> ⚠️ *This is archived documentation. It describes a process specific to the legacy Web Order System and Customer Portal. See [current Standards & Procedures](../../standards-and-procedures/) for up-to-date documentation.*
