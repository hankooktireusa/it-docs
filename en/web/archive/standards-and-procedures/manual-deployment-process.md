---
layout: default
title: Manual Deployment Process (Legacy)
permalink: /en/web/archive/standards-and-procedures/manual-deployment-process/
---
...
> ⚠️ *This is archived documentation. It describes the manual deployment process for the legacy Customer Portal and Web Order System projects, which are no longer active. See [current Standards & Procedures](../../standards-and-procedures/) for up-to-date documentation.*
